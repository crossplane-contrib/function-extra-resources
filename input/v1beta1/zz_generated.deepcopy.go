...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Into) DeepCopyInto(out *Into) {
	*out = *in
	if in.Type != nil {
	...
	if in.ContextKey != nil {
		in, out := &in.ContextKey, &out.ContextKey
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Into.
func (in *Into) DeepCopy() *Into {
	if in == nil {
		return nil
	}
	out := new(Into)
